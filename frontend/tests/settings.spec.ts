...
test.describe('Settings', () => {
  ...
  test('[TC-SETTINGS-001] should display settings page', async ({ page }) => {
  ...
  test('[TC-SETTINGS-002] should toggle theme', async ({ page }) => {
    // Wait for page to load
    await page.waitForLoadState('networkidle');
    await page.waitForTimeout(1000);
  ...
  test('[TC-SETTINGS-003] should change password', async ({ page }) => {
    // Wait for page to load
    await page.waitForLoadState('networkidle');
    await page.waitForTimeout(1000);
  ...
  test('[TC-SETTINGS-004] should view feature requests', async ({ page }) => {
    // Wait for page to load
    await page.waitForLoadState('networkidle');
    await page.waitForTimeout(1000);
